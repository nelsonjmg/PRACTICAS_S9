...
\hline
\multicolumn{1}{|l|}{}         & \multicolumn{5}{l|}{Fotoperiodo (horas de oscuridad por ciclo de 24 horas)}                                                          \\ \hline
\multicolumn{1}{|l|}{Genotipo} & \multicolumn{1}{l|}{0}   & \multicolumn{1}{l|}{2}   & \multicolumn{1}{l|}{4}   & \multicolumn{1}{l|}{8}   & \multicolumn{1}{l|}{16}  \\ \hline
\multicolumn{1}{|l|}{Armelle}  & \multicolumn{1}{l|}{630} & \multicolumn{1}{l|}{610} & \multicolumn{1}{l|}{560} & \multicolumn{1}{l|}{570} & \multicolumn{1}{l|}{590} \\ \hline
\multicolumn{1}{|l|}{Golden}   & \multicolumn{1}{l|}{640} & \multicolumn{1}{l|}{630} & \multicolumn{1}{l|}{600} & \multicolumn{1}{l|}{620} & \multicolumn{1}{l|}{620} \\ \hline
\multicolumn{1}{|l|}{Promise}  & \multicolumn{1}{l|}{640} & \multicolumn{1}{l|}{630} & \multicolumn{1}{l|}{650} & \multicolumn{1}{l|}{620} & \multicolumn{1}{l|}{580} \\ \hline
\multicolumn{1}{|l|}{Emir}     & \multicolumn{1}{l|}{660} & \multicolumn{1}{l|}{660} & \multicolumn{1}{l|}{620} & \multicolumn{1}{l|}{610} & \multicolumn{1}{l|}{630} \\ \hline
                               &                          &                          &                          &                          &                         
\end{tabular}
\end{table}
...
\\
\begin{enumerate}
  \item Las 20 observaciones constituyen muestras aleatorias independientes, cada una de tamaño 3, de 20 poblaciones con medias $\mu_ij$, $i=1, 2, 3, 4$  y    $j = 1, 2, 3, 4,5$.
  \item Cada una de las 20 poblaciones es normal.
  \item Cada una de las 20 poblaciones tiene la misma varianza.
  \item Los efectos de los bloques y tratamientos son aditivos; es decir, no existe interacción entre los bloques y tratamientos. Esto significa que si hay diferencias entre dos tratamientos cualesquiera, estas se mantienen en todos los bloques (abetos).
\end{enumerate}
...
\\
\begin{itemize}
  \item Variable respuesta: Número de días hasta la aparición de síntomas visibles.
  \item Factor: Genotipo que tiene cuatro niveles. Es un factor de efectos fijos ya que viene decidido qué niveles concretos se van a utilizar.
  \item Bloque: Fotoperiodo que tiene cinco niveles. Es un factor de efectos fijos ya que viene decidido qué niveles concretos se van a utilizar.
  \item Modelo completo: Los cuatro tratamientos se prueban en cada bloque exactamente una vez.
\end{itemize}
